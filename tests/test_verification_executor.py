...
class VerificationExecutorTests(unittest.TestCase):
    ...
    def test_executor_uses_full_cloudmail_list_for_myalias_confirmation_lookup(self):
    ...
    def test_executor_scans_full_list_for_myalias_confirmation_lookup(self):
    ...
    def test_executor_prefers_service_account_email_as_myalias_confirmation_target(self):
        ...
        fake_time = mock.Mock()
        fake_time.monotonic.side_effect = [0.0, 0.0, 1.0]
        captured = {"list_calls": [], "match_alias_calls": []}
